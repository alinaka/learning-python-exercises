...
если число делится на 5, вывести вместо него Buzz, а если делится и на три, и на 5, то вывести вместо этого
числа FizzBuzz.
...
for i in range(a, b + 1):
    print("Fizz" if i % 3 == 0 else "", "Buzz" if i % 5 == 0 else "", i if i % 3 != 0 and i % 5 != 0 else "", sep="")
